...
int main() {
    ...
    pointLight[0] = PointLight(glm::vec3(0.0f, 0.0f, 1.0f), 0.1f, 1.0f, glm::vec3(4.0f, 0.0f, 0.0f), 0.3f, 0.2f, 0.1f);
    pointLight[1] = PointLight(glm::vec3(0.0f, 1.0f, 0.0f), 0.1f, 1.0f, glm::vec3(-4.0f, 0.0f, 0.0f), 0.3f, 0.2f, 0.1f);
